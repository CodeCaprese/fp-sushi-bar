...
return [
    ...
    */
    ...
    'gte' => [
        'numeric' => ':Attribute muss größer oder gleich als :value sein.',
    ],
    ...
    */
    ...
    'custom' => [
        ...
        'numberOfSeats' => [
            'required' => 'Bitte Sitze angeben.',
            'gte' => 'Die Anzahl der Sitze muss mindestens :value betragen.'
        ],

        'numberOfCustomers' => [
            'required' => 'Bitte Kunden/innen angeben.',
            'gte' => 'Die Anzahl der Kunden/innen muss mindestens :value betragen.',
            'lte' => 'Die Anzahl der Kunden/innen darf maximal :value betragen.',
        ],
    ],
    'billing_rule_group_not_at_table' => 'Die Gruppe ist nicht mehr am Tisch.',
